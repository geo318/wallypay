...
export const Highlights = ({ text }: { text: HomeText['highlights'] }) => (
  <div>
    ...
    <div className='grid lg:grid-cols-8 sm:grid-cols-4 grid-cols-2 gap-y-5 bg-[#EAFAFF] shadow-[0_200rem_0_200rem_#EAFAFF] lg:mt-14 mt-8 px-5 lg:py-16 py-10 lg:px-16'>
